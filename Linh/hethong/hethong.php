...
=======
                <a href="http://localhost/QuanLyTrangThietBi/Dat/Ph%c3%a2n%20lo%e1%ba%a1i%20kho%20ph%c3%b2ng/phanloaikp.php" class="list-group-item list-group-item-action">Phân loại kho phòng</a>
                <a href="http://localhost/QuanLyTrangThietBi/Dat/Ph%c3%a2n%20lo%e1%ba%a1i%20thi%e1%ba%bft%20b%e1%bb%8b/phanloaitb.php" class="list-group-item list-group-item-action">Phân loại thiết bị</a>
                <a href="http://localhost/QuanLyTrangThietBi/Dat/Danh%20s%c3%a1ch%20m%c3%b4n%20ng%c3%a0nh/dsmonnganh.php" class="list-group-item list-group-item-action">Danh sách môn/ngành</a>
                <a href="http://localhost/QuanLyTrangThietBi/Dat/Danh%20s%c3%a1ch%20ph%c3%b2ng%20ban/dsphongban.php" class="list-group-item list-group-item-action">Danh sách phòng ban</a>
                <a href="http://localhost/QuanLyTrangThietBi/Dat/Danh%20s%c3%a1ch%20t%c3%b2a%20nh%c3%a0/dstoanha.php" class="list-group-item list-group-item-action">Danh sách toà nhà</a>
                <a href="http://localhost/QuanLyTrangThietBi/Dat/Danh%20s%c3%a1ch%20ngu%e1%bb%93n%20c%e1%ba%a5p/dsnguoncap.php" class="list-group-item list-group-item-action">Danh sách nguồn cấp</a>
>>>>>>> 1729ad7 (đạt)
            </div>
        </div>
...
=======
                <a href="http://localhost/QuanLyTrangThietBi/Linh/quanlytaikhoan/quanlytaikhoan.php" class="list-group-item list-group-item-action">Quản lý tài khoản</a>
>>>>>>> 1729ad7 (đạt)
              </div>
        </div>
    </div>
