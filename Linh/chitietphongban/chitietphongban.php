...
<div class="content" style="padding: 2%;">
    <div class="thanhctrl" style="padding-right: 50px;">
        ...
        <div style="margin-right: 450px">
            <button class="btn btn-warning" style="color: white; background-color: rgb(245, 155, 0); font-weight: bold; height: 40px;" name ="nhapthietbi">Nhập thiết bị</button>
            <button class="btn btn-warning" style="color: white; background-color: rgb(245, 155, 0); font-weight: bold; height: 40px;" name = "trathietbi">Trả thiết bị</button>
        </div>
    </div>
    <br>
