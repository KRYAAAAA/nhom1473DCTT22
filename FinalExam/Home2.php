...
<head>
  ...
  <link rel="stylesheet" href="css/bootstrap.min.css">
    ...
    <link rel="stylesheet" href="/opt/lampp/htdocs/QuanLyTrangThietBi/Linh/format1.css">
...
<div style="display: inline-block; vertical-align: top; flex:1">
  <div class="thanhtren">
    <div>
      <a href="http://qlttb.com/QuanLyTrangThietBi/VietAnh/FinalExam/Home2.php" style="color: rgb(0, 172, 0); width:fit-content; display: inline-block; font-weight: bold; font-size:120%">DANH SÁCH THIẾT BỊ</a>
      <a href="http://qlttb.com/QuanLyTrangThietBi/VietAnh/qlkhophong/Home2.php" style="color: rgb(200,200,200); width:fit-content; display: inline-block">DANH SÁCH KHO PHÒNG</a>
    </div>
      <a href="http://qlttb.com/QuanLyTrangThietBi/login/login.php" style="color: gray; display: inline-block;" onclick="return confirm('Bạn có muốn đăng xuất không')">Đăng xuất</a>
  </div>
<?php 
