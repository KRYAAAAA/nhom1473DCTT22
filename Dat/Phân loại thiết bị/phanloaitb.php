<?php
    ...
    $sql = "SELECT * FROM `phanloaitb` WHERE 1";
?>
<?php
if(isset($_POST['btntimkiem'])){
    include_once 'timkiem5.php';
}
?>
<?php
    if(isset($_POST['btnthem'])){
        if(($_POST['txtmapl'] !="") && ($_POST['txttenpl']!="")){
            include_once 'thêm5.php';
        }else{
...
if(isset($_POST['btnxoa'])){
    include_once 'xoa5.php';
}
?>
<?php
    if(isset($_POST['btnsua'])){
        if(($_POST['txtmapl'] !="") && ($_POST['txttenpl']!="")){
            include_once 'sua5.php';
        }else{
            echo "<script>alert('Hãy nhập đủ thông tin!')</script>";
        }
    }  
...
?>
    ...
    <div class ="noidung">
        <div class="thanhtren">
            <h5 style="color: rgb(0, 172, 0);">PHÂN LOẠI THIẾT BỊ</h5>
